...
export default function PatientDetailModal({
  ...
  const handleChange = (e: React.ChangeEvent<HTMLInputElement | HTMLSelectElement>) => {
    setFormData((prev) => {
      if (!prev) return prev;
      return { ...prev, [e.target.name]: e.target.value } as PatientResponse;
    });
  };
            ...
            <div>
              ...
              <div className="relative">
                <select
                  ...
                  onChange={handleChange}
                  disabled={!isEditing}
                  className={`w-full px-4 py-2 border rounded-lg focus:ring-2 focus:ring-blue-500 outline-none transition-all appearance-none ${
                    isEditing
                      ? "bg-white border-gray-300"
                      : "bg-gray-50 border-transparent text-gray-600"
                  }`}
