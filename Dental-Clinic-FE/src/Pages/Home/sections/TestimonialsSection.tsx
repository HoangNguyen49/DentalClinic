...
const feedbacks = [
  {
    ...
    detailKey: "testimonials.detail1"
  },
  {
    image: patient2,
    quoteKey: "testimonials.quote2",
    nameKey: "testimonials.name2",
    detailKey: "testimonials.detail2"
  },
  {
    image: patient3,
    quoteKey: "testimonials.quote3",
    nameKey: "testimonials.name3",
    detailKey: "testimonials.detail3"
  }
];
      ...
      <div className="max-w-7xl w-full mx-auto px-4 md:px-8 text-center">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 items-center">
          <div className="relative flex justify-start md:pl-15">
            <img src={current.image} alt={t(current.nameKey)} className="rounded-3xl w-72 h-auto object-cover shadow-lg" />
          </div>
          <div className="text-left">
            <p className="text-gray-600 text-lg italic mb-6">“{t(current.quoteKey)}”</p>
            <hr className="my-4" />
            <div className="flex justify-between items-center">
              <div></div>
              <div className="text-right">
                <p className="text-[#3366FF] font-semibold">{t(current.nameKey)}</p>
                <p className="text-gray-500 text-sm">{t(current.detailKey)}</p>
              </div>
            </div>
          </div>
        </div>
