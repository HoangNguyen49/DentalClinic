        ...
        <div className="max-w-6xl mx-auto grid grid-cols-3 items-center mb-12">
          ...
          <div className="hidden md:flex flex-col items-center space-y-2">
            ...
            <p className="text-base md:text-lg text-center">
              {t("hero.avatarLeft.line1")} <br />
              <span className="text-[#3366FF] font-bold">
                {t("hero.avatarLeft.brand")}
              </span>
            </p>
          </div>
          ...
          <div className="hidden md:flex flex-col items-center space-y-2">
            ...
            />
            <p className="text-base md:text-lg text-center">
              {t("hero.avatarRight.line1")} <br />
              {t("hero.avatarRight.line2")}
            </p>
          </div>
        </div>
        ...
        <div className="flex justify-center mt-8">
          <div className="relative">
            ...
            <div className="absolute top-[20%] left-0 md:-left-10">
              <span className="flex items-center gap-1 bg-white text-[#3366FF] rounded-full px-3 py-1 text-xs md:text-sm shadow border border-blue-100">
                <ShieldCheckIcon className="w-4 h-4 md:w-5 md:h-5" />
                {t("hero.tags.preventive")}
              </span>
            </div>
