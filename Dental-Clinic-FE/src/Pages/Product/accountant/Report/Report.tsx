    ...
    <div className="min-h-screen bg-gray-50/50 p-6 font-sans space-y-8 animate-fade-in-up">
      ...
      <div className="bg-white p-5 rounded-2xl shadow-sm border border-gray-100 flex flex-col md:flex-row justify-between items-center gap-4">
        ...
        <div className="flex flex-wrap items-center gap-3">
          ...
          <div className="bg-gray-100 p-1 rounded-xl flex items-center">
            {(["USD", "VND"] as const).map((curr) => (
              <button
                ...
                className={`px-4 py-2 text-xs font-bold rounded-lg transition-all duration-200 ${filters.currency === curr
          ...
          <button
            onClick={exportExcel}
            className="flex items-center gap-2 px-5 py-2.5 bg-emerald-600 hover:bg-emerald-700 text-white rounded-xl text-sm font-semibold shadow-sm transition-all active:scale-95"
          >
